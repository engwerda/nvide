...
return packer.startup(function(use)
  ...
  use({
	...
	use({ "lukas-reineke/indent-blankline.nvim", config = get_config("indent-blankline"), commit = "6177a59552e35dfb69e1493fd68194e673dc3ee2" })
  ...
  use ("Mofiqul/dracula.nvim")
	...
	-- cmp plugins
	use({ "hrsh7th/nvim-cmp", config = get_config("cmp"), commit = "df6734aa018d6feb4d76ba6bda94b1aeac2b378a" }) -- The completion plugin
  ...
  use({ "github/copilot.vim", config = get_config("copilot") })
	...
	-- LSP
	use({ "neovim/nvim-lspconfig", config = get_config("lsp/init"), commit = "148c99bd09b44cf3605151a06869f6b4d4c24455" }) -- enable LSP
  ...
  use({
	...
	-- Telescope
	use({ "nvim-telescope/telescope.nvim", config = get_config("telescope"), commit = "d96eaa914aab6cfc4adccb34af421bdd496468b0" })

	-- Treesitter
	use({ "nvim-treesitter/nvim-treesitter", config = get_config("treesitter"), commit = "518e27589c0463af15463c9d675c65e464efc2fe" })
